...
class duel:
    ...
    def update_weapon_ranking(self, fencer):
        ...
        # rankings DataFrame
            ...
            self.rankings_df_new = pd.concat([self.rankings_df_new, pd.DataFrame([unranked_fencer_deets])],
            ignore_index = True)
